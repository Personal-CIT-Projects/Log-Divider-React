...
import {useDivider} from "../../../Functions/Dividers/translatorReview";
import translatorReviewFormat from "../../../Functions/Formats/translatorReviewFormat";

export default function TranslatorReview() {
    const [input, setInput] = useState("")
    const [month, setMonth] = useState("")
    const [preferClipboard, setPreferClipboard] = useState(true)
    const divider = useDivider()
    const clipboard = useClipboard()
    const format = translatorReviewFormat(divider.getNick(), divider.getAccount(), divider.translations.length, divider.login.length, divider.getPlaytime())
    ...
    return <>
        ...
        <Grid container>
            <ContentArea title={"Translations"} content={divider.translations}/>
        </Grid>
    </>
}
