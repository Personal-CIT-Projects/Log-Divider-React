export default function guiderAppReviewFormat(countryChat:string[], loginCount:number, playtime:{start: number, end: number, calculated: number}) : string {
    ...
    result += `\n4) [b]Country chat hits for the past 2 months:[/b] ${countryChat.length} [spoiler]${countryChat.join('\n')}[/spoiler]`
